...
\subsection*{Iterationsplanung}
	\begin{tabularx}{\textwidth}{lXXl}
		...
		\\ \hline
			E3 	&
			16. Aufsetzen und Anpassen der \mbox{Azure} Cloud \newline 17. Programmierung Azure Binding \newline 18. Integration \mbox{Azure} Cloud \newline 19. Integration Tinkerforge &
		\begin{minipage}[t]{\linewidth}
				\begin{itemize}[leftmargin=*]
