...
\end{lstlisting}
Dieser Startup Task führt das Batchfile «startup.cmd» aus, welches das Zertifikat in den Store hinzufügt. Dazu muss das Zertifikat dem Visual-Studio-Projekt als Element hinzugefügt werden, und in dessen Eigenschaften für den Buildvorgang als «Inhalt» deklariert werden.
...
\tbd Authentifizierung mit Benutzername und Passwort.
