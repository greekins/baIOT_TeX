...
Im SDK befinden sich Klassen für die Verwendung des REST-API und Model-Klassen, um die Daten des API intern zu repräsentieren. Zudem werden im SDK auch diverse Hilfsklassen zu finden sein. \\
